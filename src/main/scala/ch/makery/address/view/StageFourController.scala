...
import ch.makery.address.model.Beiorg
...
// Controller for stage four of the game (StageFour.fxml)
@sfxml
class StageFourController(
                           // HP GUI
  ...
  def battle(action: ActionEvent): Unit = {
    ...
    enemyMoveStack.push("ATTACK") // Move 6
    enemyMoveStack.push("ATTACK") // Move 5
    enemyMoveStack.push("BREAK") // Move 4
    enemyMoveStack.push("ATTACK") // Move 3
    enemyMoveStack.push("ATTACK") // Move 2
    enemyMoveStack.push("GUARD") // Move 1
